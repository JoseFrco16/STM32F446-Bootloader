...
App/Header/%.o App/Header/%.su App/Header/%.cyclo: ../App/Header/%.c App/Header/subdir.mk
...
clean-App-2f-Header:
	-$(RM) ./App/Header/Header.cyclo ./App/Header/Header.d ./App/Header/Header.o ./App/Header/Header.su
